...
public class Jogador {
	...
	/**
	 * soma dos números das peças na mão do jogador
	 * @return soma dos números das peças na mão do jogador
	 */
	public int getSomaNumPecas() {
		int soma = 0;
