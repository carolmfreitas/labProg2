...
class PecaTest {
	...
	@Test
	void testGetSomaNumerosDaPeca() {
		Peca peca = new Peca(6, 1);
		assertEquals(7,peca.getSomaNumerosDaPeca());
	}
	
	@Test
	void testEncaixaEsquerda() {
		Peca peca = new Peca(6, 1);
		assertTrue(peca.encaixa(6));
	}
	
	@Test
	void testEncaixaDireita() {
		Peca peca = new Peca(6, 1);
		assertTrue(peca.encaixa(1));
	}
}
